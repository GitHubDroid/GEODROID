...
import static eu.geodroid.library.util.LibraryConstants.PREFS_KEY_BASEFOLDER;
import static eu.geodroid.library.util.LibraryConstants.PREFS_KEY_CUSTOM_EXTERNALSTORAGE;
import static eu.geodroid.library.util.Utilities.messageDialog;
