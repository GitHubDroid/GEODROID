...
import static eu.geodroid.library.util.LibraryConstants.PREFS_KEY_ELEV;
import static eu.geodroid.library.util.LibraryConstants.PREFS_KEY_LAT;
import static eu.geodroid.library.util.LibraryConstants.PREFS_KEY_LON;
import static eu.geodroid.library.util.LibraryConstants.PREFS_KEY_MAPCENTER_LAT;
import static eu.geodroid.library.util.LibraryConstants.PREFS_KEY_MAPCENTER_LON;
import static eu.geodroid.library.util.LibraryConstants.PREFS_KEY_MAP_ZOOM;
