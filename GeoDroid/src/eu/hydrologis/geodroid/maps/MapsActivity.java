...
import eu.geodroid.library.util.activities.GeocodeActivity;
import eu.geodroid.library.util.activities.InsertCoordActivity;
...
import eu.hydrologis.geodroid.maps.overlays.ArrayGeopaparazziOverlay;
import eu.hydrologis.geodroid.maps.tiles.CustomTileDownloader;
import eu.hydrologis.geodroid.maps.tiles.GeopackageTileDownloader;
import eu.hydrologis.geodroid.maps.tiles.MapGeneratorInternal;
import eu.hydrologis.geodroid.osm.OsmCategoryActivity;
import eu.hydrologis.geodroid.osm.OsmTagsManager;
